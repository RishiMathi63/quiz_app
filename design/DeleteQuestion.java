...
public class DeleteQuestion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(new java.awt.Font("Book Antiqua", 0, 36)); // NOI18N
        ...
        jTextField7.setForeground(new java.awt.Color(247, 91, 44));

        jButton3.setBackground(new java.awt.Color(0, 0, 0));
        jButton3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton3.setForeground(new java.awt.Color(247, 91, 44));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                JFrame jf=new JFrame();
                jf.setAlwaysOnTop(true);
                JOptionPane.showMessageDialog(jf,"Question id error");
            }
        }
        catch(Exception e){
            JFrame jf=new JFrame();
